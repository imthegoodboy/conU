...
That npm package is a thin native-binary launcher. Rust remains the product; npm only downloads the matching checksummed release asset with bounded request time and response sizes, then exposes the commands on `PATH`.
