...
- Distributed multi-instance session migration/accounting, distributed dashboards, adaptive abuse response, hosted tenant lifecycle/workflow automation beyond one relay's account suspension/scoped admin tenant commands, and distributed hosted mailbox retention orchestration remain future hardening work.
