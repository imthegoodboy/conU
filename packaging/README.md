...
directory, non-HTTPS metadata rejection, forbidden local-state/secret marker
rejection, and separate repository Pages metadata readiness before GitHub Pages
upload. Custom DNS/TLS/cache policy and
