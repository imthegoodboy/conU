...
Current latest hardening addition: npm install target hardening is complete; PR
#359 merged to `main` at merge commit
`d5b2dd4605213291dfcfbf665b5dcb59a6803d6f`, Issue #358 is closed, and branch
`npm-install-target-hardening` is preserved. Prior completed hardening addition:
Linux public-key export descriptor-bound IO handling is complete; PR #357 merged
