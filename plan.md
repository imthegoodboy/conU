...
- Issue #234 tracks this follow-up on branch
  `github-pages-readiness-preflight`; the branch must be preserved.
...
- PR CI, branch Release Artifacts, merge, and post-merge gates are still pending
  for this branch.
...
- Complete local validation, open PR #235 or next available PR from
  `github-pages-readiness-preflight`, run PR/Release Artifacts gates, merge to
  `main`, and preserve the branch.
