...
Current latest hardening addition: message IPC marker collision hardening is
complete; PR #411 merged to `main` at merge commit
`7406ac1e403ceb82dc627ec9346f1dc29fb07813`, Issue #410 is closed, and branch
`message-ipc-marker-collision-guard` is preserved. Validation:
...
completed hardening addition: request archive marker collision hardening is
