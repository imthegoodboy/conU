...
Current latest hardening addition: package-manager manifest private-key block
guard is complete; PR #375 merged to `main` at merge commit
`0961affd951d9449390c5a6ba2d2b683dce4dea2`, Issue #374 is closed, and branch
`package-manifest-private-key-block-guard` is preserved. Validation: focused
`py_compile`, package-manager manifest regression, package-manager submission
regression, `git diff --check`, and PR CI passed. Prior completed hardening
addition: GitHub Release unexpected asset gate is complete; PR #373 merged to
