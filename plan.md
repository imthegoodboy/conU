...
Current latest hardening addition: hosted repository Pages preparation input
...
`hosted-pages-input-bounds` is preserved. Prior completed hardening addition:
hosted repository S3 publication metadata input handling is complete; PR #325
merged to `main` at merge commit `1774979ea6b03a0d991d200546b70dcf9a616154`,
Issue #324 is closed, and branch `hosted-s3-metadata-input-bounds` is
preserved. Prior completed hardening addition: Linux public-key export output
handling is complete; PR #323 merged
