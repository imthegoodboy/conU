...
Current latest hardening addition: GitHub Release unexpected asset gate is
complete; PR #373 merged to `main` at merge commit
`09aeb820731dc5047808cb873fe95d9f06d6248f`, Issue #372 is closed, and branch
`release-asset-unexpected-gate` is preserved. Validation: focused
`py_compile`, GitHub Release asset publication regression, tagged release
readiness regression, `git diff --check`, and PR CI passed. Prior completed
hardening addition: release update-policy signature private-key armor guard is
complete; PR #371 merged to `main` at merge commit
