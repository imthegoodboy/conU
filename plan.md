...
Current latest hardening addition: local secret file symlink hardening is
complete; PR #417 merged to `main` at merge commit
`cea78dc8b03669905c48eaa51850c4d05a0b5106`, Issue #416 is closed, and branch
`secret-file-symlink-guard` is preserved. Validation:
...
completed hardening addition: message delivery receipt collision hardening is
