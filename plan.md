...
Current latest hardening addition: Linux repository metadata signing
descriptor-bound IO handling is complete; PR #353 merged to `main` at merge
commit `c28f33a3a44a4087639cd212669192d115ae93fd`, Issue #352 is closed, and
branch `linux-repository-signing-descriptor-io` is preserved. Prior completed
