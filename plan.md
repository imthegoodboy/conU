...
Current latest hardening addition: release update staged source read hardening is
complete; PR #403 merged to `main` at merge commit
`b25710ba87fc8eae128e4e1ee399dd14c95b9c94`, Issue #402 is closed, and branch
`update-staged-source-read-guard` is preserved. Validation:
...
completed hardening addition: release update final install target replacement
