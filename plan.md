...
- Run post-merge main CI and main `Release Artifacts` for this plan update,
  then cut a real signed `v*` release and run `conu update check --policy-url`
  against the published policy before adding automatic update artifact
  download/apply behavior.
