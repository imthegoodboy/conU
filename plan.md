...
Current latest hardening addition: request archive marker collision hardening is
complete; PR #409 merged to `main` at merge commit
`071526f7b671d379b06e3c1d1f04f60ea4360e44`, Issue #408 is closed, and branch
`request-archive-collision-guard` is preserved. Validation:
...
missing `dlltool.exe` and `link.exe`; PR CI covered Rust on Ubuntu, macOS, and
Windows. Prior completed hardening addition: release update backup restore read
