...
Current latest hardening addition: Linux public-key export output handling is
complete; PR #323 merged to `main` at merge commit
`edb55a86abc528efac27984daff8b7fbc2f74e38`, Issue #322 is closed, and branch
`linux-public-key-export-output-bounds` is preserved. Prior completed hardening
addition: RPM package signing file handling is complete; PR #321 merged to
