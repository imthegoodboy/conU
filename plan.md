...
Current latest hardening addition: release archive root guard is complete;
PR #301 merged to `main` at merge commit
`52221eb28d2230bdebe9b7b22c01d15425167b86`, Issue #300 is closed, and branch
`update-archive-root-guard` is preserved. Prior completed hardening addition:
Rust update public-host IP guard is complete; PR #299 merged to `main` at merge
