...
Current latest hardening addition: GitHub main branch protection readiness is
complete; PR #273 merged to `main` at merge commit
`7367be16fa656d2c936d0f597b5321009f4e4631`, Issue #272 is closed, branch
`github-main-branch-protection` is preserved, and live `main` protection is
enabled with strict required CI checks.
