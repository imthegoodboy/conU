...
Latest hardening addition: npm installer local binary directory preflight hardening is complete in PR #189 on branch `npm-installer-local-binary-dir-guard` for Issue #188 pending CI/main verification.
```
...
- Issue #188 tracks npm installer local binary override preflight hardening, and PR #189 on branch `npm-installer-local-binary-dir-guard` carries the implementation.
