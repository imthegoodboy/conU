...
- PR #255 is open for this hardening work; Issue #254 is linked, and branch
  `published-update-apply-gate` must be preserved after merge.
...
- Require PR #255 CI plus branch `Release Artifacts`, merge without deleting
  `published-update-apply-gate`, then observe the next signed `v*` release to
  prove the public check/download/apply dry-run gate against real uploaded
  assets before npm publication.
