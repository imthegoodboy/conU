...
Current latest hardening addition: release update apply rollback error
...
`update-apply-rollback-errors` is preserved. Validation: `cargo fmt --all -- --check`, `git diff --check`, release-version check, and PR CI passed.
