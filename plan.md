...
Current latest hardening addition: message delivery receipt collision hardening
is complete; PR #415 merged to `main` at merge commit
`ac78cbe3d5b258269f2c344f07d147b3d323bf88`, Issue #414 is closed, and branch
`message-delivery-receipt-guard` is preserved. Validation:
...
completed hardening addition: pairing invite file collision hardening is
