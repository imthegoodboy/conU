...
Current latest hardening addition: npm publish package-version consistency gate
is complete; PR #379 merged to `main` at merge commit
`5569ccdf1570ec84d46f67433012091c3a1f5f8c`, Issue #378 is closed, and branch
`npm-publish-version-consistency` is preserved. Validation: focused
`py_compile`, npm publish preflight regression, npm publish preflight,
release-version check, `git diff --check`, and PR CI passed. Prior completed
