...
Current latest hardening addition: RPM package signing file handling is
complete; PR #321 merged to `main` at merge commit
`d66b872f53d85a1bcec32dfe98727d996fc84f5d`, Issue #320 is closed, and branch
`rpm-package-signing-file-bounds` is preserved. Prior completed hardening
