...
Current latest hardening addition: release smoke archive root guard is complete;
PR #303 merged to `main` at merge commit
`f5b13df2fd9ad34f6d5d3db874ed93f4ed2964fd`, Issue #302 is closed, and branch
`release-smoke-root-guard` is preserved. Prior completed hardening addition:
release archive root guard is complete; PR #301 merged to `main` at merge
