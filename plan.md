...
- Issue #206 tracks the work on branch `apt-repository-metadata`; branches must
  be preserved after merge.
...
- Finish local validation, open PR for Issue #206, run PR CI and branch
  `Release Artifacts`, then merge without deleting branches if checks stay
  green.
