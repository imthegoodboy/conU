...
- Issue #192 tracks release artifact smoke binary preflight hardening, and PR #193 on branch `release-artifact-smoke-binary-preflight` carries the implementation.
...
- Run PR CI plus branch `Release Artifacts`, merge only after green gates, verify main CI and main `Release Artifacts`, and preserve the `release-artifact-smoke-binary-preflight`, `npm-smoke-local-binary-preflight`, and `npm-installer-local-binary-dir-guard` branches.
