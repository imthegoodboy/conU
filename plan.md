...
- Issue #260 tracks this hardening work on branch
...
- Finish local production-readiness validation, open and merge a PR for Issue
  #260, verify PR and post-merge CI/Release Artifacts runs, then observe the
  next signed `v*` release asset set including the signed submission bundle.
