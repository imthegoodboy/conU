...
- Issue #186 tracks npm installer archive-member preflight hardening, and branch `npm-installer-archive-preflight-bounds` carries the implementation.
...
- Open PR for issue #186, run PR CI and branch `Release Artifacts`, merge without deleting branches if gates pass, then verify main CI and main `Release Artifacts`.
