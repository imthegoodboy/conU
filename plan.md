...
Current latest hardening addition: package-manager release archive ingestion
bounds are complete; PR #311 merged to `main` at merge commit
`deffe7ba3b6f0cee3fc1938089d02a9ae8894042`, Issue #310 is closed, and branch
`package-manager-archive-bounds` is preserved. Prior completed hardening
addition: hosted repository ZIP ingestion bounds are complete; PR #309 merged to
