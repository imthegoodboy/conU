...
Current latest hardening addition: pairing invite file collision hardening is
complete; PR #413 merged to `main` at merge commit
`41489fdba3daca1a8b0eecfeecd77b3d5b752c3f`, Issue #412 is closed, and branch
`pairing-invite-collision-guard` is preserved. Validation:
...
completed hardening addition: message IPC marker collision hardening is
