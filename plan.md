...
Current latest hardening addition: hosted repository bundle descriptor-bound IO
handling is complete; PR #339 merged to `main` at merge commit
`7539be6b372fbdc544b85691ac480c30f04a69d4`, Issue #338 is closed, and branch
`hosted-bundle-descriptor-io` is preserved. Prior completed hardening addition:
