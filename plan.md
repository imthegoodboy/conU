...
Current latest hardening addition: release update binary permission handle
hardening is complete; PR #405 merged to `main` at merge commit
`c62d2c3600b152cf68b159093fc132b4888540c8`, Issue #404 is closed, and branch
`update-binary-permission-handle` is preserved. Validation:
...
completed hardening addition: release update staged source read hardening is
