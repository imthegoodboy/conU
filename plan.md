...
- Issue #184 tracks bounded npm installer extracted-tree selection, and branch `npm-installer-extract-bounds` carries the implementation.
...
- Open PR for issue #184, run PR CI and branch `Release Artifacts`, merge without deleting branches if gates pass, then verify main CI and main `Release Artifacts`.
