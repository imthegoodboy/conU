...
Current latest hardening addition: package-manager manifest descriptor-bound IO
handling is complete; PR #337 merged to `main` at merge commit
`dc15b786571bbf69a64845cf7a49d1836d6767a7`, Issue #336 is closed, and branch
`package-manifest-descriptor-io` is preserved. Prior completed hardening addition:
