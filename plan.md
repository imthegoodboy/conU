...
Current latest hardening addition: Linux release signing file handling is
complete; PR #317 merged to `main` at merge commit
`c2017b15ad619a3fccf319f13d15f34167df9051`, Issue #316 is closed, and branch
`linux-signing-source-bounds` is preserved. Prior completed hardening addition:
