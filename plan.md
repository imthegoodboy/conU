...
Current latest hardening addition: release update backup restore read hardening
is complete; PR #407 merged to `main` at merge commit
`95b4c64918491072ecdbd95289c04a621925dc80`, Issue #406 is closed, and branch
`update-backup-restore-read-guard` is preserved. Validation:
...
completed hardening addition: release update binary permission handle hardening
