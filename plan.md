...
Current latest hardening addition: GitHub Release prerelease flag gate is
complete; PR #377 merged to `main` at merge commit
`bdc01de58e676be2c0c00e4d9ad2922b0d78d38c`, Issue #376 is closed, and branch
`release-prerelease-flag-gate` is preserved. Validation: focused `py_compile`,
GitHub Release asset publication regression, tagged release readiness regression,
`git diff --check`, and PR CI passed. Prior completed hardening addition:
