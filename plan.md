...
Current latest hardening addition: release update file creation hardening is
complete; PR #391 merged to `main` at merge commit
`1d7f0bbb0a59c2b58ba802775cd0da3adad4e327`, Issue #390 is closed, and branch
`update-file-create-new-hardening` is preserved. Validation: `cargo fmt --all -- --check`,
