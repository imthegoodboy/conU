...
Current latest hardening addition: release update-policy source input bounds are
complete; PR #315 merged to `main` at merge commit
`1a3892def80d48469065b36832e20286061969f2`, Issue #314 is closed, and branch
`update-policy-source-bounds` is preserved. Prior completed hardening addition:
package-manager submission source ingestion bounds are complete; PR #313 merged to
