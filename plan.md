...
Current latest hardening addition: GitHub workflow permissions readiness is
complete; PR #278 merged to `main` at merge commit
`1a8e026d00a44bce85e85788782c432310965ece`, Issue #277 is closed, and branch
`github-workflow-permissions-readiness` is preserved. Prior completed
hardening addition: GitHub Actions permissions readiness is complete; PR #276
