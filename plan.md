...
Current latest hardening addition: release update input file read hardening is
complete; PR #399 merged to `main` at merge commit
`ef418a89eff1ea86b861407ce09b384b3401552e`, Issue #398 is closed, and branch
`release-update-input-file-hardening` is preserved. Validation:
...
`link.exe`/`dlltool.exe`; PR CI covered Rust on Ubuntu, macOS, and Windows.
Prior completed hardening addition: downloaded release update metadata write
