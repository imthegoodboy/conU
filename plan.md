...
- Issue #194 tracks npm publish conflict preflight hardening on branch `npm-publish-conflict-preflight`.
...
- Finish local validation, open a PR for Issue #194, run PR CI plus branch `Release Artifacts`, merge only after green gates, verify main CI and main `Release Artifacts`, and preserve the `npm-publish-conflict-preflight`, `release-artifact-smoke-binary-preflight`, `npm-smoke-local-binary-preflight`, and `npm-installer-local-binary-dir-guard` branches.
