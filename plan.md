...
- Issue #246 is tracked by PR #247 on branch
  `release-update-remote-check`; the branch is preserved.
...
- PR #247 is open; let PR CI exercise the linked Rust tests, then run the
  Release Artifacts workflow on this branch. After merge, cut a real signed
