...
Latest hardening addition: npm installer local binary directory preflight hardening is complete on branch `npm-installer-local-binary-dir-guard` for Issue #188 pending PR/main verification.
```
...
- Issue #188 tracks npm installer local binary override preflight hardening, and branch `npm-installer-local-binary-dir-guard` carries the implementation.
...
- Open the PR, run PR CI plus branch `Release Artifacts`, merge only after green gates, verify main CI and main `Release Artifacts`, and preserve the branch.
