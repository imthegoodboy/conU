...
Current latest hardening addition: public signature private-key armor guard is
complete; PR #367 merged to `main` at merge commit
`cd537113dcda17d51625b53ea5ae91be17a6422c`, Issue #366 is closed, and branch
`public-signature-private-key-guard` is preserved. Validation: focused
`py_compile`, package-manager submission, hosted repository, hosted site
regressions, `git diff --check`, and PR CI passed. Prior completed hardening
addition: package-manager submission public-key private armor guard is complete;
