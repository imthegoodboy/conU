...
- Issue #256 tracks this hardening work on branch
  `hosted-linux-repository-endpoint-readiness`.
...
- Open and merge the PR after CI/package checks pass, preserve branch
  `hosted-linux-repository-endpoint-readiness`, then observe the next signed
  `v*` release and any custom repository endpoint activation with the live
  endpoint readiness command.
