...
Current latest hardening addition: package-manager submission public-key private
armor guard is complete; PR #365 merged to `main` at merge commit
`082e843f5b6e36a4ab7150b40ab1757c80a36b47`, Issue #364 is closed, and branch
`package-submission-public-key-guard` is preserved. Validation: focused
`py_compile`, `check-package-manager-submissions.py`, `git diff --check`, and
PR CI passed. Prior completed hardening addition: release archive secret-file guard is
