...
Current latest hardening addition: release update backup restore hardening is
complete; PR #395 merged to `main` at merge commit
`3d0781aba64b4b50d998985c4bfb8792e458cec7`, Issue #394 is closed, and branch
`update-restore-create-new-hardening` is preserved. Validation: `cargo fmt --all -- --check`,
