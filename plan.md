...
Current latest hardening addition: release artifact verifier file boundary
handling is complete; PR #333 merged to `main` at merge commit
`4ad9de5cb0cfc47a5aab34ed92e1ee91fbe60754`, Issue #332 is closed, and branch
`release-artifact-file-bounds` is preserved. Prior completed hardening addition:
