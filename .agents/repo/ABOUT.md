...
- GitHub CI and release artifact workflows, including Rust OS-matrix checks plus TypeScript SDK, npm launcher package checks with archive preflight, trusted download URL, bounded download coverage, verified npm package content dry-runs, release archive verification, GitHub Release asset upload, and optional npm package publishing
