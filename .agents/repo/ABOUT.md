...
- GitHub CI and release artifact workflows, including Rust OS-matrix checks plus TypeScript SDK, npm launcher package checks with archive preflight, trusted download URL, and bounded download coverage, release archive verification, GitHub Release asset upload, and optional npm package publishing
