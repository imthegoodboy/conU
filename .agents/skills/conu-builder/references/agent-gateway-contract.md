...
conu-relay --admin-abuse-threshold-report --relay <endpoint> --admin-token-stdin [--account <account-id>] [--node <node-id>] --max-<metric> <count>... [--json]
