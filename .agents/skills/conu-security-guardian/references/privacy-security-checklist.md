...
- Relay mailbox stores encrypted envelopes only; relay accounting and relay abuse files store metadata counters only. Hosted mailbox retention dashboards and distributed adaptive abuse workflows remain future work.
