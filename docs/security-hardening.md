...
- Distributed multi-instance relay session migration, distributed hosted dashboards/accounting, hosted relay mailbox retention policy, and full hosted tenant administration around the current single-relay account credential lifecycle.
