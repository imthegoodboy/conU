...
- Verify tagged Linux release assets with SHA-256 sidecars, GitHub attestations, `conu-linux-gpg-key.asc`, detached `.asc` signatures, and native APT/RPM repository metadata signatures when those assets are published.
