...
- Distributed multi-instance relay session migration/accounting, distributed hosted accounting dashboards beyond local/admin-gated single-relay dashboard snapshots, hosted retry policy, destructive distributed hosted mailbox retention orchestration beyond local/admin-gated audit plus local manual purge/scheduled purge workflows, and managed mailbox retention dashboards beyond single-relay audit snapshots.
