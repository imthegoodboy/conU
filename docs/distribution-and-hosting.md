...
4. Add distributed account control planes, distributed monitoring/dashboards, hosted mailbox retention policy, and distributed hosted session state before opening a managed relay to everyone.
