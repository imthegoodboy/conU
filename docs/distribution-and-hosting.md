...
4. Add distributed account control planes, distributed monitoring/dashboards, hosted mailbox retention policy, and distributed multi-instance session migration before opening a managed relay to everyone.
