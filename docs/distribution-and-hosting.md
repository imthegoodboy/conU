...
live endpoint Cache-Control behavior, Pages extraction path, and GitHub Pages repository metadata readiness plus
...
do not submit package-manager repository PRs or automate custom DNS/TLS
publication, and unattended automatic update apply remains disabled by policy.
